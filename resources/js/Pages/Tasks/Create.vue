            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Add a new task to track and manage your work
                    </p>
                </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-6">
                            <div class="flex items-center mb-6">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Set priority, status, and categorization
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-6">
                            <div class="flex items-center mb-6">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Upload relevant documents and images
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                >
                                    ...
                                    <select
                                        ...
                                        class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 focus:ring-1 transition-colors"
                                        :class="{
                                            'border-red-500 focus:border-red-500':
