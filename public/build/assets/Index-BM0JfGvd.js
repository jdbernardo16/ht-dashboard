...
import { _ as Q } from "./AuthenticatedLayout-DcS0JwOY.js";
import { D as W, _ as X } from "./Pagination-DqAuicJN.js";
import "./_plugin-vue_export-helper-DlAUqK2U.js";
import "./Modal-CXplEik2.js";
const Z = { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" },
    ee = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8" },
    te = {
        class: "bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 border border-green-100",
    },
    oe = { class: "flex items-center" },
    se = { class: "ml-4" },
    le = { class: "text-2xl font-bold text-gray-900" },
    re = {
    ...
    ve = { class: "p-6" },
    ye = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" },
    he = { class: "lg:col-span-2" },
    we = { class: "relative" },
    ke = ["value"],
    _e = { class: "mt-4" },
    Ce = ["aria-expanded"],
    ...
    je = { class: "mt-6 flex flex-col sm:flex-row gap-3 justify-end" },
    Fe = ["disabled"],
    Me = {
        key: 0,
        class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6",
    },
    Te = { class: "animate-pulse space-y-4" },
    Ve = { class: "space-y-3" },
    Ae = {
        key: 1,
    ...
    Pe = { class: "font-semibold text-green-600 text-lg" },
    $e = { class: "text-sm text-gray-900" },
    Ee = { class: "font-medium text-gray-900" },
    Ue = {
        class: "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800",
    },
    Oe = { class: "border-t border-gray-200" },
    Ye = {
        __name: "Index",
        props: {
            sales: { type: Object, required: !0 },
        ...
        setup(T) {
            const r = T,
                ...
                l = h({
                    ...
                    min_amount: r.filters.min_amount || "",
                    max_amount: r.filters.max_amount || "",
                    payment_method: r.filters.payment_method || "",
                }),
                a = k(() => r.sales.data || []),
                v = k(() => Object.values(l.value).some((s) => s !== "")),
                V = [
                    { key: "id", label: "ID", sortable: !0 },
                    { key: "product_name", label: "Product", sortable: !0 },
                    ...
                    { key: "payment_method", label: "Payment", sortable: !0 },
                ],
                A = [
                ...
                y = () => {
                    f.visit("/sales/create");
                },
                D = (s) => {
                    f.visit(`/sales/${s.id}/edit`);
                },
                z = (s) => {
                    f.visit(`/sales/${s.id}`);
                },
                N = async (s) => {
                    if (confirm("Are you sure you want to delete this sale?"))
                        try {
                            ...
                            (d.value = !1),
                                console.error("Error deleting sale:", t);
                        }
                },
                P = () => {
                ...
                U = () =>
                    a.value.length === 0
                        ...
                        : (
                              a.value.reduce(
                                  (t, o) => t + parseFloat(o.amount || 0),
                                  0
                              ) / a.value.length
                          ).toFixed(2),
                O = () => a.value.filter((s) => s.status === "pending").length,
                H = (s) => parseFloat(s).toFixed(2),
                I = (s) => (s ? new Date(s).toLocaleDateString() : "N/A"),
                L = (s) =>
                    s
                        ...
                        : "",
                q = (s) =>
                    ({ cash: "Cash", card: "Card", online: "Online" }[s] || s),
                R = (s) =>
                    ({
                                                    ...
                                                    c(
                                                        e(
                                                            "input",
                                                            {
                                                                ...
                                                                type: "text",
                                                                placeholder:
                                                                    "Search by product name or client...",
