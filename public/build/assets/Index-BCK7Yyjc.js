...
import { _ as pe, c as fe } from "./AuthenticatedLayout-DcS0JwOY.js";
import { D as ge, _ as me } from "./Pagination-DqAuicJN.js";
import { _ as be } from "./FormModal-CgEwW3r6.js";
import "./_plugin-vue_export-helper-DlAUqK2U.js";
import "./Modal-CXplEik2.js";
const ve = { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" },
    xe = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8" },
    ye = {
    ...
    je = { class: "ml-4" },
    Se = { class: "text-2xl font-bold text-gray-900" },
    Me = {
    ...
    Ae = { class: "flex items-center" },
    Be = { class: "ml-4" },
    ze = { class: "text-2xl font-bold text-gray-900" },
    De = {
        class: "bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8",
    },
    Le = { class: "p-6" },
    Ne = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" },
    qe = { class: "lg:col-span-2" },
    He = { class: "relative" },
    Ve = ["value"],
    Ie = ["value"],
    Oe = { class: "mt-4" },
    ...
    We = ["value"],
    Ye = { class: "mt-6 flex flex-col sm:flex-row gap-3 justify-end" },
    Ge = ["disabled"],
    Ke = {
        key: 0,
        class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6",
    },
    Je = { class: "animate-pulse space-y-4" },
    Qe = { class: "space-y-3" },
    Re = {
        key: 1,
    ...
    nt = { class: "font-semibold text-gray-900 max-w-xs truncate" },
    at = { class: "flex flex-wrap gap-1" },
    it = { class: "text-sm text-gray-900" },
    dt = { class: "flex items-center" },
    ut = { class: "text-sm text-gray-900" },
    ct = { class: "border-t border-gray-200" },
    xt = {
        __name: "Index",
        props: {
            contentPosts: { type: Object, required: !0 },
        ...
        setup(m) {
            const p = m,
                ...
                l = f({
                    ...
                    content_type: p.filters.content_type || "",
                    platform: p.filters.platform || "",
                    date_from: p.filters.date_from || "",
                    date_to: p.filters.date_to || "",
                }),
                c = N(() => p.contentPosts.data || []),
                j = N(() => Object.values(l.value).some((s) => s !== "")),
                I = [
                    { key: "id", label: "ID", sortable: !0 },
                    { key: "image", label: "Image", sortable: !1 },
                    { key: "title", label: "Title", sortable: !0 },
                    { key: "platform", label: "Platforms", sortable: !0 },
                    { key: "content_type", label: "Type", sortable: !0 },
                    {
                    ...
                    { key: "user", label: "Author", sortable: !0 },
                ],
                A = [
                ...
                W = async () => {
                    try {
                        const s = await ce.get("/api/categories", {
                            headers: fe(),
                            withCredentials: !0,
                        });
                        E.value = s.data.data;
                        const t = z.find((o) => o.name === "category_id");
                        t &&
                            (t.options = E.value.map((o) => ({
                                value: o.id,
                                label: o.name,
                            })));
                    } catch (s) {
                        console.error("Error fetching categories:", s);
                    }
                },
                S = () => {
                    u.visit("/content/create");
                },
                Y = (s) => {
                    u.visit(`/content/${s.id}/edit`);
                },
                G = (s) => {
                    u.visit(`/content/${s.id}`);
                },
                K = async (s) => {
                    if (
                        confirm(
                        ...
                        try {
                            await u.delete(`/content/${s.id}`),
                                u.reload({ only: ["contentPosts"] });
                        } catch (t) {
                            console.error("Error deleting content:", t);
                        }
                },
                J = async (s) => {
                    b.value = !0;
                    try {
                        ...
                        await u[k](o, t, {
                            ...
                            preserveScroll: !0,
                            onSuccess: () => {
                                D(), u.reload({ only: ["contentPosts"] });
                            },
                            onError: (i) => {
                                formModal.value && formModal.value.setErrors(i),
                                    console.error("Error saving content:", i);
                            },
                        });
                    } catch (t) {
                        console.error("Error submitting form:", t);
                    } finally {
                        b.value = !1;
                    }
                },
                ...
                R = () =>
                    c.value.filter((s) => s.status === "published").length,
                X = () =>
                    c.value.filter((s) => s.status === "scheduled").length,
                Z = () => c.value.filter((s) => s.status === "draft").length,
                ee = (s) => (s ? new Date(s).toLocaleDateString() : "N/A"),
                te = (s) =>
                ...
                ne = (s) => {
                    (s.target.style.display = "none"),
                        (s.target.parentElement.innerHTML = `
                                      ...
                                      n("div", Ze, [
                                          ...
                                          e("div", ct, [
                                              M(
                                                  me,
                                                  {
                                                      links: m.contentPosts
                                                          .links,
                                                      from: m.contentPosts.from,
                                                      to: m.contentPosts.to,
                                                      total: m.contentPosts
                                                          .total,
                                                      onNavigate: Q,
