...
import { _ as ae } from "./AuthenticatedLayout-DcS0JwOY.js";
...
const ce = { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" },
    me = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8" },
    ge = {
    ...
    ye = { class: "ml-4" },
    he = { class: "text-2xl font-bold text-gray-900" },
    we = {
    ...
    Pe = { class: "mt-6 flex flex-col sm:flex-row gap-3 justify-end" },
    Ue = ["disabled"],
    Oe = {
        key: 0,
        class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6",
    },
    Ie = { class: "animate-pulse space-y-4" },
    He = { class: "space-y-3" },
    Le = {
        key: 1,
    ...
    Je = { class: "font-bold text-red-600 text-lg" },
    Ke = { class: "text-sm text-gray-900" },
    Qe = {
        class: "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800",
    },
    Xe = { class: "font-medium text-gray-900" },
    Ze = { class: "flex items-center space-x-1" },
    et = ["src", "alt"],
    tt = {
        key: 1,
        class: "h-10 w-10 bg-blue-100 rounded border flex items-center justify-center shadow-sm",
    },
    st = { key: 0, class: "text-xs text-gray-500 ml-1" },
    ot = { key: 1, class: "text-xs text-gray-400" },
    rt = { class: "border-t border-gray-200" },
    mt = {
        __name: "Index",
        setup(lt) {
            const { expenses: n, filters: c } = ee().props,
                v = x(!1),
                y = x(!1),
                T = x(!1),
                A = x(!1),
                ...
                S = se(() => Object.values(r.value).some((o) => o !== "")),
                z = [
                    ...
                    { key: "merchant", label: "Merchant", sortable: !0 },
                    { key: "receipts", label: "Receipts", sortable: !1 },
                ],
                V = [
                ...
                E = () => {
                    b.visit("/expenses/create");
                },
                U = (o) => {
                    b.visit(`/expenses/${o.id}/edit`);
                },
                O = (o) => {
                    b.visit(`/expenses/${o.id}`);
                },
                I = (o) => {
                    confirm("Are you sure you want to delete this expense?") &&
                        b.delete(`/expenses/${o.id}`, {
                            preserveScroll: !0,
                            onSuccess: () => {},
                        });
                },
                ...
                M = () => {
                    (T.value = !1), p.reset(), m.value && m.value.resetForm();
                },
                G = () =>
                    n.data
                        .reduce((o, t) => o + parseFloat(t.amount || 0), 0)
                        .toFixed(2),
                W = () =>
                    n.data.length === 0
                        ? "0.00"
                        : (
                              n.data.reduce(
                                  (t, s) => t + parseFloat(s.amount || 0),
                                  0
                              ) / n.data.length
                          ).toFixed(2),
                Y = () => n.data.filter((o) => o.status === "paid").length,
                J = () => n.data.filter((o) => o.status === "pending").length,
                K = (o) => parseFloat(o).toFixed(2),
                Q = (o) => (o ? new Date(o).toLocaleDateString() : "N/A"),
                X = (o) =>
                                            ...
                                            e("div", Ve, [
                                                ...
                                                t[20] ||
                                                    (t[20] = e(
                                                        ...
                                                        " Search by description, merchant, category, or receipt number ",
                                                        -1
                                                    )),
                                            ]),
                                            e("div", null, [
