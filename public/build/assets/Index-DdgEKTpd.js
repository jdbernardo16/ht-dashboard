...
import { _ as L } from "./AuthenticatedLayout-DcS0JwOY.js";
import { D as q, _ as R } from "./Pagination-DqAuicJN.js";
import "./_plugin-vue_export-helper-DlAUqK2U.js";
import "./Modal-CXplEik2.js";
const W = { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" },
    G = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8" },
    J = {
        class: "bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-3 border border-blue-100",
    },
    K = { class: "flex items-center" },
    Q = { class: "ml-4" },
    X = { class: "text-2xl font-bold text-gray-900" },
    Z = {
    ...
    re = { class: "ml-4" },
    ne = { class: "text-2xl font-bold text-gray-900" },
    ie = {
        class: "bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-3 border border-yellow-100",
    },
    ae = { class: "flex items-center" },
    de = { class: "ml-4" },
    ue = { class: "text-2xl font-bold text-gray-900" },
    ce = {
        class: "bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8",
    },
    me = { class: "p-6" },
    ge = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" },
    pe = { class: "lg:col-span-2" },
    fe = { class: "relative" },
    ve = ["value"],
    be = { class: "mt-6 flex flex-col sm:flex-row gap-3 justify-end" },
    xe = ["disabled"],
    he = {
        key: 0,
        class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6",
    },
    ye = { class: "animate-pulse space-y-4" },
    we = { class: "space-y-3" },
    ke = {
        key: 1,
    ...
    Te = { class: "flex-shrink-0 h-12 w-12" },
    Be = {
        key: 0,
    ...
    He = { class: "text-white font-bold text-sm" },
    Ve = { class: "ml-4" },
    Ae = { class: "font-semibold text-gray-900" },
    Ne = { key: 0, class: "text-sm text-gray-500" },
    De = ["href"],
    $e = { key: 1, class: "text-gray-400" },
    Ee = { class: "flex items-center" },
    Oe = {
        key: 0,
    ...
    Pe = { key: 1, class: "text-gray-900" },
    Ue = { key: 2, class: "text-gray-400" },
    Ye = {
        key: 0,
        class: "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800",
    },
    Ie = { key: 1, class: "text-gray-400" },
    Le = { class: "flex items-center" },
    qe = { class: "font-semibold text-green-600" },
    Re = { class: "flex items-center" },
    We = { class: "font-semibold text-purple-600" },
    Ge = { class: "border-t border-gray-200" },
    et = {
        __name: "Index",
        props: {
            clients: { type: Object, required: !0 },
        ...
        setup(T) {
            const a = T,
                ...
                i = w({
                    ...
                    category: a.filters.category || "",
                    company: a.filters.company || "",
                }),
                u = k(() => a.clients.data || []),
                p = k(() => Object.values(i.value).some((o) => o !== "")),
                B = [
                    {
                        value: "Consignment Partner",
                ...
                S = [
                    { key: "name", label: "Client", sortable: !0 },
                    { key: "email", label: "Email", sortable: !0 },
                    { key: "phone", label: "Phone", sortable: !0 },
                    { key: "company", label: "Company", sortable: !0 },
                    { key: "category", label: "Category", sortable: !0 },
                    {
                        key: "sales_count",
                        label: "Sales",
                        type: "number",
                ...
                f = () => {
                    m.visit("/clients/create");
                },
                F = (o) => {
                    m.visit(`/clients/${o.id}/edit`);
                },
                H = (o) => {
                    m.visit(`/clients/${o.id}`);
                },
                V = async (o) => {
                    if (
                        confirm(
                        ...
                        try {
                            ...
                            (d.value = !1),
                                console.error("Error deleting client:", t);
                        }
                },
                A = () => {
                ...
                h = () => {
                    (i.value = { search: "", category: "", company: "" }), g();
                },
                N = (o) => {
                    m.visit(o, {
                        preserveState: !0,
                ...
                D = () => u.value.reduce((o, t) => o + (t.sales_count || 0), 0),
                $ = () =>
                    u.value.reduce(
                        (o, t) => o + (t.content_posts_count || 0),
                        0
                    ),
                E = () => {
                    const o = new Date().getMonth(),
                        t = new Date().getFullYear();
                    return u.value.filter((s) => {
                        const y = new Date(s.created_at);
                        return y.getMonth() === o && y.getFullYear() === t;
                    }).length;
                },
                O = (o, t) =>
                    `${o?.charAt(0) || ""}${t?.charAt(0) || ""}`.toUpperCase();
            return (
                P(
                    i,
                    () => {
                                      ...
                                      r("div", Ce, [
                                          ...
                                          e("div", Ge, [
                                              z(
                                                  R,
                                                  {
                                                      links: a.clients.links,
                                                      from: a.clients.from,
                                                      to: a.clients.to,
                                                      total: a.clients.total,
                                                      onNavigate: N,
