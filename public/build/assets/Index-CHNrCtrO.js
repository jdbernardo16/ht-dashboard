...
const ge = { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" },
    ...
    pe = { class: "ml-4" },
    fe = { class: "text-2xl font-bold text-gray-900" },
    ve = {
    ...
    qe = { class: "p-6" },
    Ve = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" },
    Ge = { class: "lg:col-span-2" },
    Be = { class: "relative" },
    De = ["value"],
    Ne = ["value"],
    Pe = { class: "mt-4" },
    ...
    Le = { class: "animate-pulse space-y-4" },
    He = { class: "space-y-3" },
    Oe = {
        key: 1,
    ...
    Ke = { class: "font-semibold text-gray-900 max-w-xs" },
    Qe = { class: "font-semibold text-blue-600 text-lg" },
    Xe = { class: "w-full max-w-xs" },
    Ze = { class: "flex items-center justify-between mb-1" },
    et = { class: "text-xs font-medium text-gray-900" },
    tt = { class: "w-full bg-gray-200 rounded-full h-2" },
    lt = { class: "text-sm text-gray-900" },
    ot = { class: "border-t border-gray-200" },
    gt = {
        __name: "Index",
        setup(st) {
            const i = g([]),
                ...
                w = oe(() => Object.values(s.value).some((o) => o !== "")),
                E = [
                    { key: "id", label: "ID", sortable: !0 },
                    { key: "title", label: "Title", sortable: !0 },
                    { key: "type", label: "Type", sortable: !0 },
                    {
                        key: "target_value",
                        label: "Target",
                        type: "currency",
                    ...
                    { key: "progress", label: "Progress", sortable: !0 },
                ...
                b = () => {
                    (d.value = !0),
                        c.get("/goals", s.value, {
                            preserveState: !0,
                            onSuccess: (o) => {
                                (p.value = o.props.goals),
                                    (i.value =
                                        o.props.goals.data || o.props.goals),
                                    (d.value = !1);
                            },
                            onError: (o) => {
                                console.error("Error fetching goals:", o),
                                    (d.value = !1);
                            },
                        });
                },
                k = () => {
                    c.visit("/goals/create");
                },
                z = (o) => {
                    c.visit(`/goals/${o.id}/edit`);
                },
                U = (o) => {
                    c.visit(`/goals/${o.id}`);
                },
                I = (o) => {
                    confirm("Are you sure you want to delete this goal?") &&
                        c.delete(`/goals/${o.id}`, {
                            onSuccess: () => b(),
                            onError: (t) =>
                                console.error("Error deleting goal:", t),
                        });
                },
                L = () => {
                ...
                H = (o) => {
                    (d.value = !0),
                        q.value
                            ? c.put(`/goals/${h.value.id}`, o, {
                                  onSuccess: () => {
                                      b(), C();
                                  },
                                  onError: (t) => {
                                      formModal.value &&
                                          formModal.value.setErrors(t),
                                          (d.value = !1);
                                  },
                              })
                            : c.post("/goals", o, {
                ...
                R = () =>
                    i.value.filter((o) => o.status === "completed").length,
                W = () =>
                    i.value.filter((o) => o.status === "in_progress").length,
                Y = () =>
                    i.value
                        .reduce(
                            (o, t) => o + parseFloat(t.target_value || 0),
                            0
                        )
                        .toFixed(2),
                J = (o) => parseFloat(o).toFixed(2),
                K = (o) => (o ? new Date(o).toLocaleDateString() : "N/A"),
                Q = (o) =>
                    o.charAt(0).toUpperCase() + o.slice(1).replace("_", " "),
                X = (o) =>
                    o.charAt(0).toUpperCase() + o.slice(1).replace("_", " "),
                Z = (o) => o.charAt(0).toUpperCase() + o.slice(1),
                ee = (o) =>
                    ({
